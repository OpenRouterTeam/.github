...
<a href="https://openrouter.ai/models"><picture><source media="(prefers-color-scheme: dark)" srcset="./assets/stat-models-dark.gif"><img src="./assets/stat-models-light.gif" alt="Models on OpenRouter" width="202"></picture></a>
<a href="https://openrouter.ai/models"><picture><source media="(prefers-color-scheme: dark)" srcset="./assets/stat-providers-dark.gif"><img src="./assets/stat-providers-light.gif" alt="Providers on OpenRouter" width="202"></picture></a>
<a href="https://openrouter.ai/rankings"><picture><source media="(prefers-color-scheme: dark)" srcset="./assets/stat-tokens-dark.gif"><img src="./assets/stat-tokens-light.gif" alt="Tokens routed per month" width="202"></picture></a>
<a href="https://openrouter.ai"><picture><source media="(prefers-color-scheme: dark)" srcset="./assets/stat-users-dark.gif"><img src="./assets/stat-users-light.gif" alt="Global users on OpenRouter" width="202"></picture></a>
